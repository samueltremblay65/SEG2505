...
{
	public final static int NOMBRE_POINTS = 6000000;
	...
	public static void main(String args[])
	{
		...
		//¨ Pour le 5eme design, nous devons choisir de creer des PointCP2 ou PointCP3 dependant du type initial
		PointCP5 pointC1;
		PointCP5 pointP1;
		...
		pointC1 = new PointCP3('C', 5, 0);
		pointP1 = new PointCP2('P', 5, 0);
		
		pointC2 = new PointCP3('C', 0, 5);
		pointP2 = new PointCP2('P', 5, 90);
		
		pointC3 = new PointCP3('C', 3, 4);
		pointP3 = new PointCP2('P', 5, 53.1301);
		...
		// Partie performance : 
		// Nous allons creer un nombre NOMBRE_POINTS d'objets PointCP5. Nous allons appeller toutes les methodes publiques de la classe, dont le calcul
		// de la distance entre le PointCP5 et un autre PointCP5. Pour creer le point, nous allons utiliser des valeurs aleatoires
		...
		if(coordType == 'P')
		{
			autre = new PointCP2(coordType, xOrRho, yOrTheta);
		}
		else
		{
			autre = new PointCP3(coordType, xOrRho, yOrTheta);			
		}
		...
		for(int i = 0; i < NOMBRE_POINTS; i++)
		{
			...
			// Si type original est polaire, alors on choisit PointCP2, si cartesien, on choisit PointCP3
			if(coordType == 'P')
			{
