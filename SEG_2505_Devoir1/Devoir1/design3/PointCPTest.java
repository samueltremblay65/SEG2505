...
public class PointCPTest
{
	...
	public static void main(String args[])
	{
		...
		pointP1 = new PointCP3('P', 5, 0);
		
		pointC2 = new PointCP3('C', 0, 5);
		pointP2 = new PointCP3('P', 5, 90);
		
		pointC3 = new PointCP3('C', 3, 4);
		pointP3 = new PointCP3('P', 5, 53.1301);
		...
		// Partie performance : 
		// Nous allons creer un nombre NOMBRE_POINTS d'objets PointCP3. Nous allons appeller toutes les methodes publiques de la classe, dont le calcul
		// de la distance entre le PointCP3 et un autre PointCP3. Pour creer le point, nous allons utiliser des valeurs aleatoires
