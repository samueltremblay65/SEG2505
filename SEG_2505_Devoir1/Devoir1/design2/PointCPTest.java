...
public class PointCPTest
{
	...
	public static void main(String args[])
	{
		...
		pointC1 = new PointCP2('C', 5, 0);
		pointP1 = new PointCP2('P', 5, 0);
		
		pointC2 = new PointCP2('C', 0, 5);
		pointP2 = new PointCP2('P', 5, 90);
		
		pointC3 = new PointCP2('C', 3, 4);
		...
		// Partie performance : 
		// Nous allons creer un nombre NOMBRE_POINTS d'objets PointCP2. Nous allons appeller toutes les methodes publiques de la classe, dont le calcul
		// de la distance entre le PointCP2 et un autre PointCP2. Pour creer le point, nous allons utiliser des valeurs aleatoires
