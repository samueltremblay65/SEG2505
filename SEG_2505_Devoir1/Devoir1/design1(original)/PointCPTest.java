...
public class PointCPTest
{
	...
	public static void main(String args[])
	{
		...
		pointC1 = new PointCP('C', 5, 0);
		pointP1 = new PointCP('P', 5, 0);
		
		pointC2 = new PointCP('C', 0, 5);
		pointP2 = new PointCP('P', 5, 90);
		
		pointC3 = new PointCP('C', 3, 4);
		pointP3 = new PointCP('P', 5, 53.1301);
		...
		// Partie performance : 
		// Nous allons creer un nombre NOMBRE_POINTS d'objets PointCP. Nous allons appeller toutes les methodes publiques de la classe, dont le calcul
		// de la distance entre le PointCP et un autre PointCP. Pour creer le point, nous allons utiliser des valeurs aleatoires
		...
		autre = new PointCP(coordType, xOrRho, yOrTheta);
		...
		for(int i = 0; i < NOMBRE_POINTS; i++)
		{
			...
			// Creation de l'objet
			point = new PointCP(coordType, xOrRho, yOrTheta);
